...
export type RequirementType = 'DATA_REPORT' | 'BUSINESS_FLOW' | 'API_INTEGRATION' | 'UI_CHANGE' | 'RULE_CHANGE' | 'OTHER';
...
export type DemandStatus = 'SUBMITTED' | 'QUESTIONING' | 'IN_PROGRESS' | 'ARCHIVED' | 'DONE';
...
export type Source = 'wecom' | 'web' | 'import';
